...
public class ManageWindchillPart {
    ...
    private String Root = directory.getCanonicalPath();
    ExcelReader excelReader= ExcelReader.getInstance(Root + "\\src\\main\\java\\Windchill","Credentials.xlsx","Sheet1");
    WebDriver driver;
    ExtentTest logger;
    ...
    */
    ...
    public void LaunchWindchillBrowser() throws InterruptedException, AWTException {
        ...
        Thread.sleep(2000);
        Robot rb = new Robot();
        List<String> cred1= excelReader.getRowData(1,0);
    ...
    public void createPart() throws InterruptedException {
        ...
        for (String window : windows)
        {
            ...
            if (driver.getTitle().contains("New Part"))
            {
                ...
                implicitWait(10);
                Thread.sleep(5000);
                driver.findElement(By.xpath("//td[@attrid='name']/input[1]")).sendKeys(DefaultPart);
                Thread.sleep(2000);
                driver.findElement(By.xpath("//button[@accesskey='f']")).click();
                Thread.sleep(5000);
